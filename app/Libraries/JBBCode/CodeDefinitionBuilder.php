...
class CodeDefinitionBuilder
{
     ...
     * @return self
     */
    public function setOptionValidator(\App\Libraries\JBBCode\InputValidator $validator, $option=null)
    {
        if(empty($option)){
            $option = $this->tagName;
        }
     ...
     * @return self
     */
    public function setBodyValidator(\App\Libraries\JBBCode\InputValidator $validator)
    {
