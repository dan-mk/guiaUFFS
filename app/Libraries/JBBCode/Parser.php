...
class Parser
{
    ...
    {
        $nestLimitVisitor = new \App\Libraries\JBBCode\visitors\NestLimitVisitor();
    ...
    /**
     *\App\Libraries\JBBCode parsing logic is loosely modelled after a FSM. While not every function maps
