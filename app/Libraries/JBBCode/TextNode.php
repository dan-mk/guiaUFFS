...
class TextNode extends Node
{
    ...
    /**
     * (non-PHPdoc)
     * @see\App\Libraries\JBBCode.Node::isTextNode()
     *
    ...
    /**
     * (non-PHPdoc)
     * @see\App\Libraries\JBBCode.Node::getAsText()
     *
    ...
    /**
     * (non-PHPdoc)
     * @see\App\Libraries\JBBCode.Node::getAsBBCode()
     *
    ...
    /**
     * (non-PHPdoc)
     * @see\App\Libraries\JBBCode.Node::getAsHTML()
     *
