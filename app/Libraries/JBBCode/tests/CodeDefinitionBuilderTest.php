...
class CodeDefinitionBuilderTest extends PHPUnit_Framework_TestCase
{
    ...
    public function testSetOptionValidator()
    {
        ...
        $otherUrlValidator = new\App\Libraries\JBBCode\validators\UrlValidator();
    ...
    public function testSetBodyValidator()
    {
        ...
        $validator = new\App\Libraries\JBBCode\validators\UrlValidator();
    ...
    public function testRemoveOptionValidator()
    {
        ...
        $this->assertEmpty($this->_builder->getOptionValidators());
        $this->_builder->setOptionValidator(new\App\Libraries\JBBCode\validators\UrlValidator());
        $this->assertSame($this->_builder, $this->_builder->removeOptionValidator());
        $this->assertEmpty($this->_builder->getOptionValidators());
    }
...
class CodeDefinitionBuilderStub extends \App\Libraries\JBBCode\CodeDefinitionBuilder
{

    /**
     * @return \App\Libraries\JBBCode\InputValidator
     */
