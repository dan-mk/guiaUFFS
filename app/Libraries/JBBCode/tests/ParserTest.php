...
class ParserTest extends PHPUnit_Framework_TestCase {
    /**
     * @var\App\Libraries\JBBCode\Parser
     */
    private $_parser;

    protected function setUp()
    {
        $this->_parser = new\App\Libraries\JBBCode\Parser();
        $this->_parser->addCodeDefinitionSet(new\App\Libraries\JBBCode\DefaultCodeDefinitionSet());
    }
