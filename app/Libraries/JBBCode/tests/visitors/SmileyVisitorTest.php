...
class SmileyVisitorTest extends PHPUnit_Framework_TestCase {
    /** @var \App\Libraries\JBBCode\visitors\SmileyVisitor */
    private $_smileyVisitor;

    protected function setUp()
    {
        $this->_smileyVisitor = new \App\Libraries\JBBCode\visitors\SmileyVisitor();
    }
    ...
    {
        $builder = new \App\Libraries\JBBCode\CodeDefinitionBuilder('foo', 'bar');
    ...
    {
        $textNode = new\App\Libraries\JBBCode\TextNode('');
    ...
    {
        $textNode = new\App\Libraries\JBBCode\TextNode($string);
        $textNode->accept($this->_smileyVisitor);
