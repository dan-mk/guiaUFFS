...
class TagCountingVisitorTest extends \PHPUnit_Framework_TestCase {
    /** @var \App\Libraries\JBBCode\visitors\TagCountingVisitor */
    protected $_tagCountingVisitor;

    protected function setUp()
    {
        $this->_tagCountingVisitor = new\App\Libraries\JBBCode\visitors\TagCountingVisitor();
    }
    ...
    /**
     * @covers\App\Libraries\JBBCode\visitors\TagCountingVisitor::getFrequency()
     * @covers\App\Libraries\JBBCode\visitors\TagCountingVisitor::visitElementNode()
     */
